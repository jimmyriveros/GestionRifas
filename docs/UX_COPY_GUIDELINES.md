...
| Ahí, un orden que la consulta SÍ aplica y el teléfono no ofrece —llegó de la pantalla grande o de un enlace guardado— | Se **describe**, no se esconde: **«Rifa, de la Z a la A»**, **«Vendedor, de la A a la Z»**, y un estado por su primera etiqueta, **«Estado de la boleta, primero Borrador»** (D-216) | Caer al orden por defecto, que anunciaría uno y enseñaría otro; y «de la A a la Z» para un estado, que se ordena por su lista de valores y no por el alfabeto |
