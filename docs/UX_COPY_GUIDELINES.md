...
|---|---|
| La guía §8 propone «Eliminar vendedor», pero el sistema **no borra nada** (ni política ni privilegio de `DELETE` en ninguna tabla — D-038) | Se conserva la **estructura** del ejemplo y se cambia el verbo: **Desactivar vendedor**, **Archivar cliente**, **Anular pago**. La consecuencia se explica igual: «Ya no podrá ingresar a la aplicación. Las ventas que registró permanecerán guardadas.» |
