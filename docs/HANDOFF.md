...
| Último cambio promovido | **`e2b604a`** — **la deuda real de formato, saldada** (16 archivos), 2026-08-28; sin migración, CI 2/2, despliegue verificado por el identificador `ad94db8e07ba` |
