...
| Último cambio promovido | **`ef6bcb2`** — **el hueco de la barra de selección múltiple** (D-110), 2026-08-24; sin migración, CI 2/2 y despliegue verificado por SHA |
...
| Remoto | `github.com/jimmyriveros/GestionRifas`. `main` local y `origin/main` coincidían en **`ef6bcb2`** el 2026-08-24, tras el push de D-110; a partir de ahí vuelve a comprobarse con Git, no se asume por este texto |
...
| Pruebas | **325 unitarias**, **518 de base de datos** (+6 de `read-performance`) y **293 E2E** (242 escritorio + **51 móvil**, D-111), revalidadas el 2026-08-24 con `verify` en verde. La suite de base de datos aguanta pasadas seguidas sobre la misma base (I-057 e I-059); la de E2E **no**, y hay que sembrarla limpia antes de una pasada completa. CI en GitHub Actions desde la Fase 8 |
...
## 1.a Último relevo significativo — la paginación en el teléfono (2026-08-24)
...
| Publicación | **No desplegado.** Commit local, sin push (el hash va en el reporte de entrega, §0). Requiere autorización expresa del dueño |
...
| Git | Rama `main`, base observada `7706378`, árbol limpio antes de empezar |
