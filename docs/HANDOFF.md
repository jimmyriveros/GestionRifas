...
| Pendiente | **1)** **Desplegar**, que necesita autorización. Sin migración: la reversión sería un Instant Rollback. **2)** Verificación visual con sesión real, que un agente no hace en producción (I-066). **3)** Lo de siempre: I-077, I-072, I-074, I-075, I-068, I-066, I-062, I-063 |
| Git | Rama `main`, sobre `380be5c`. **Sin desplegar** |
