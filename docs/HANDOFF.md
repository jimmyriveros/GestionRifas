...
| Último cambio promovido | **`0b05fd9`** — **editar el valor de un abono vigente** (D-134), 2026-08-29; migración `0034` aplicada al proyecto real, CI 2/2, despliegue verificado por el identificador `dddfeddf377c` |
