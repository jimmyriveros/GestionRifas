...
| Último cambio promovido | **`18ad9bd`** — **el rediseño de la ficha del cliente** (D-113), 2026-08-25; sin migración, CI 2/2 y despliegue verificado por SHA |
...
| Git | Rama `main`, de `3136c9d` a **`18ad9bd`**, empujado a `origin/main` |
