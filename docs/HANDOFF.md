...
| **Sin desplegar** | El **código** del precio ($120.000) sigue sin publicarse: la migración `0027` ya está en el proyecto real, pero Vercel corre `66ca9a7`. Consecuencia acotada: el formulario de **rifa nueva** ofrece $100.000 hasta que se despliegue. Todo lo demás lee el precio de la base y ya dice $120.000 |
