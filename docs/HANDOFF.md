...
| Último cambio promovido | **`1d12081`** — **el menú se abre flotando donde no cabe** (D-132), 2026-08-28; sin migración, CI 2/2, y despliegue verificado por el identificador `e25b8f1dda89` **y** por las tres huellas CSS que solo genera este cambio |
