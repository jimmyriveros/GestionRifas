...
| Último cambio promovido | **`0d6d7ea`** — **editar el precio de venta de una boleta asignada** (D-137), 2026-08-29; migración `0035` aplicada al proyecto real, CI 2/2, despliegue verificado por el identificador `2ac42dbe11ea` |
