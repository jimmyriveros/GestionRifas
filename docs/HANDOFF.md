...
| **Rendimiento** | Auditado con volumen real el **2026-08-22** (D-102, D-103): 100.005 clientes, 300.033 boletas y 1.000.006 pagos en base local. Las cinco pantallas más usadas pasaron de **0,6–1,4 s** a **0,1–0,3 s**. Migración **`0030`** y código **ya en producción** (`d15d386`, 2026-08-22). Con el volumen real de hoy —46 clientes, 121 boletas— **no se nota**, y es lo esperado: es preventiva. Lo que queda por decidir está en I-062 (búsqueda por texto bajo RLS) e I-063 (agregados lineales) |
