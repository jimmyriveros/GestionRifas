...
| Pendiente | **1)** Verificación visual con sesión real (I-066): vendedor → Registrar abono **en un iPhone o Android**, no en el inspector. Fecha y Método en la misma fila, sin solaparse, el valor `29/08/2026` entero, el desplegable usable. **2)** Desplegar cuando lo autorice el dueño. **3)** Lo de siempre: I-077, I-072, I-074, I-075, I-068, I-062, I-063 |
| Publicación | **Aún no desplegado.** El rediseño D-138 sigue en producción (`1d3fa54`); este arreglo va encima y necesita autorización expresa |
| Git | Rama `main`, cambios **sin commit**. No se hace push ni despliegue sin autorización |
