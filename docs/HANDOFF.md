...
| Pruebas | **320 unitarias**, **512 de base de datos** y **274 E2E**, todas revalidadas el 2026-08-21 —las E2E en una pasada completa y limpia de 13,7 min—; `verify` en verde y CI en verde sobre el commit vigente. La suite de base de datos aguanta pasadas seguidas sobre la misma base (I-057 e I-059). CI en GitHub Actions desde la Fase 8 |
