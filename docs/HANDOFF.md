...
| Último cambio promovido | **`f05c397`** — **volver al origen tras registrar un abono** (D-135), 2026-08-29; sin migración, CI 2/2, despliegue verificado por el identificador `2276f1864055` |
