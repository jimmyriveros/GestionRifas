...
| Pendiente | **1) Desplegar** (no hay migración; es solo frontend). **2)** Verificación visual con sesión real en producción, que un agente no hace. **3)** Lo de siempre: I-077, I-072, I-074, I-075, I-068, I-066, I-062, I-063 |
| Git | Rama `main`, sobre `b85dbf1`. Sin commit al escribir esto |
