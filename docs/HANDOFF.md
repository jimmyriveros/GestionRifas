...
| Último cambio promovido | **`dc97949`** — **clientes en tarjetas en el teléfono** (D-136), 2026-08-29; sin migración, CI 2/2, despliegue verificado por el identificador `13654f6048d5` y por `.max-w-\[45\%\]` |
