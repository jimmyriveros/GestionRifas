...
| Último cambio promovido | **`a031ae1`** — **el dinero fuera de los anillos y el desbordamiento a 320 px** (D-124, D-125), 2026-08-26; sin migración, CI 2/2, y despliegue verificado por el identificador de versión **y** por las cuatro reglas `cqw` que solo genera este cambio |
...
| Publicación | **NO desplegado.** Requiere autorización expresa. Lo único que ya está vivo es el `UPDATE` del nombre de la organización |
| Pendiente | Decidir **I-077** (qué se hace con el seed en producción antes de que entren vendedores reales). Autorizar el despliegue de (b) y (c). Lo de siempre: I-072, I-074, I-075, I-068, I-066, I-062, I-063 |
| Git | Rama `main`, commit base observado `0cc2789`, árbol limpio al empezar |
