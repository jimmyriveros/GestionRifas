...
| **Rendimiento** | Auditado con volumen real el **2026-08-22** (D-102, D-103): 100.005 clientes, 300.033 boletas y 1.000.006 pagos en base local. Las cinco pantallas más usadas pasaron de **0,6–1,4 s** a **0,1–0,3 s**. Migración **`0030`**, **solo en local**. Lo que queda por decidir está en I-062 (búsqueda por texto bajo RLS) e I-063 (agregados lineales) |
| Base de datos | **30 migraciones en local, 29 en el proyecto real** (falta `0030`). **`0029` se promovió el 2026-08-21** con respaldo previo en `Rifas-backups/2026-08-21-pre-0029/`. `0028` se promovió el **2026-08-17** con respaldo previo en `Rifas-backups/2026-08-17-pre-0028/`. `0027` se promovió el **2026-08-15** con respaldo previo en `Rifas-backups/2026-08-15-pre-0027/`. `0022`–`0025` se promovieron el 2026-08-13 y **`0026` el 2026-08-14**, con respaldo previo en `Rifas-backups/`. **Plan Free: sin backups automáticos** (I-024), respaldo lógico manual en §3.b |
...
## 1.a Último relevo significativo — auditoría de rendimiento con volumen real (2026-08-22)
