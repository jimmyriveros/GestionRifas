...
**Actualizado:** 2026-08-06 (busqueda hibrida; usabilidad de tablas y listas. Posterior a la Fase 9). Este documento **no oculta errores**.
...
| 2026-08-06 | — | **Busqueda hibrida** (D-078, D-079): debounce, Enter inmediato, limpiar y cancelacion en las cuatro listas y los dos selectores de cliente. +I-036 (**un vendedor con mas de 200 clientes no podia encontrar a los ultimos**), **resuelto**: era un fallo de correccion, no de rendimiento. +I-037 (el desplegable «Cliente» de los filtros sigue topado en 200, sin buscador) y +I-038 ( no aguanta datos de una corrida anterior; reproducido con el codigo intacto). Migracion : normalizacion de acentos y telefonos, e indice de trigramas en  — **aplicada solo en local** |
| 2026-08-06 | — | **Búsqueda híbrida** (D-078, D-079): pausa al escribir, `Enter` inmediato, limpiar y descarte de respuestas viejas en las cuatro listas y los dos selectores de cliente. +I-036 (**un vendedor con más de 200 clientes no podía encontrar a los últimos para venderles ni cobrarles**), **resuelto el mismo día**: era un fallo de corrección, no de rendimiento. +I-037 (el desplegable «Cliente» de los filtros sigue topado en 200, sin buscador) y +I-038 (`payments.spec.ts` no aguanta datos de una corrida anterior; reproducido con el código intacto). Migración `0017`: normalización de acentos y teléfonos en `clients`, e índice de trigramas en `tickets.internal_code`, que se buscaba sin ninguno — **aplicada solo en local** |
