...
- **Versión:** 2.23 · **Actualizado:** 2026-09-16 (**§4.11**: el motor de premios configurables,
...
| `tests/unit/lottery-dashboard.test.ts` | **+1** (D-203) | Una boleta que coincide con **sus dos números** —dos fotografías— se enseña y se cuenta **una vez** en el recuadro del Panel |
...
| ~~Que el motor use estos premios~~ | **Existe** desde la Entrega 3 (D-203): `raffle-prize-matching.test.ts`, 40 pruebas de base de datos |
...
| Un sorteo **adelantado** con un cambio de premio entre que se juega y su hora original | Reproducido a mano y registrado como **I-125**; ninguna prueba lo fija hasta que el dueño decida la regla |
