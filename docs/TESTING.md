...
`tests/db/prize-award-history.test.ts` — **61** pruebas, migraciones `0067`, `0068` y `0069`, **solo en local**.
...
| `tests/e2e/premios-ganados-movil.spec.ts` (4) | La barra inferior conserva sus cuatro y la sección se alcanza desde el menú de usuario; cada tarjeta enseña lo indispensable; **sin desplazamiento lateral** a 412 y a 320 px con un nombre larguísimo; el resumen del cliente y su enlace; y el personal con tarjetas de vendedor y sin cliente |
