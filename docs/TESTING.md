...
- **Versión:** 2.25 · **Actualizado:** 2026-09-16 (**§4.11**: la Entrega 4 —`raffle-prize-transition.test.ts` de base (38) y unitaria (30), `premios-transicion.spec.ts` (4), J13 con los seis premios confirmados y J3-03 como ejemplo genérico, D-204—). Antes, ese mismo día (**§4.11**: la corrección de la Entrega 3 —M12 y
