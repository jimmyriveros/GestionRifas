...
const UPCOMING_METRICS = [
  { label: 'Rifa activa', phase: 'la Fase 4' },
  { label: 'Total de boletas', phase: 'la Fase 4' },
  { label: 'Boletas disponibles', phase: 'la Fase 4' },
  { label: 'Boletas vendidas', phase: 'la Fase 4' },
  { label: 'Total vendido', phase: 'la Fase 6' },
  { label: 'Total recaudado', phase: 'la Fase 6' },
  { label: 'Saldo pendiente', phase: 'la Fase 6' },
  { label: 'Clientes recientes', phase: 'la Fase 4' },
]

export default async function SellerDashboardPage() {
  // Ya resuelto por seller/layout.tsx; cache() de React evita repetir la consulta.
